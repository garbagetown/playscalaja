...
Play Scala ドキュメントへようこそ。このドキュメントは Scala モジュールの **リリース 0.9.1** を対象としており、以前のバージョンのドキュメントとは大きく異なるかもしれません。
...
# "Scala テンプレート":templates
## "概要":templates#Overview
## "文法: 魔法の ‘@’ キャラクタ":templates#Syntaxthemagiccharacter
## "テンプレートパラメータ":templates#Templateparameters
## "ループ":templates#Looping
## "If ブロック":templates#IfBlocks
## "パターンマッチング":templates#Patternmatching
## "再利用できるブロックの宣言":templates#Declaringreusableblocks
## "インポート文":templates#Importstatements
## "テンプレートの構成 (tags, layouts, includes, etc.)":templates#Composingtemplatestagslayoutsincludesetc.
